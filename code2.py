...
def main():
    ...
    w = wayp0.setWaypoints(+3,84,True,True,0.0,0.0,0.0,float('nan'),47.397713,8.547605,0)
    wps.append(w)

    w = wayp1.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),47.398621,8.547745,0)
    wps.append(w)

    w = wayp2.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),47.399151,8.545320,0)
    wps.append(w)
